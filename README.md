...
Για να λειτουργήσει το σύστημα, ένας μαθητής αγγίζει το σταθερό σημείο της γείωσης πάνω στο βιβλίο. Στη συνέχεια, τα παιδιά δημιουργούν μια ανθρώπινη αλυσίδα πιάνοντας τα χέρια τους και το τελευταίο παιδί αγγίζει το αντίστοιχο αγώγιμο σημείο της σελίδας. Με αυτό το άγγιγμα, το ηλεκτρικό κύκλωμα κλείνει, και το Makey Makey στέλνει εντολή στο Scratch να προβάλει φωτογραφίες της πόλης και να αναπαράγει την αντίστοιχη ηχογράφηση, "ζωντανεύοντας" βιωματικά την ιστορία μας
...
Δοκιμάσαμε τη λειτουργία του μέσω του σώματός μας… Κλείσαμε κυκλώματα με απτά, καθημερινά υλικά… Πειραματιστήκαμε με τη ροή του ηλεκτρισμού, ανακαλύπτοντας ποια υλικά είναι αγώγιμα! 
...
Σύνδεση με το Υλικό (Physical Computing): Σχηματίσαμε τις μυστικές ψηφιακές διαδρομές σε κάθε σελίδα χρησιμοποιώντας αλουμινοταινία, ώστε να μπορούμε να συνδέσουμε το χαρτί με την πλακέτα Makey Makey… 
